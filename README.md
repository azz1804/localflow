...
- Enable `Prompt Mode` to remove speech artifacts and clarify the goal, context, constraints, and expected output without answering or inventing details. Detailed dictations keep their full meaningful context instead of being summarized. Prompt Mode and Polish are mutually exclusive.
